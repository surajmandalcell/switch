...
The app reads selected Codex and Grok Build homes through native file APIs. A
denied path is reported to the user. The app does not inspect the login Keychain.
