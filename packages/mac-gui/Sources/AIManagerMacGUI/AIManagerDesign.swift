...
enum AIMTheme {
  ...
  static let addAccountModalHeight: CGFloat = 560
...
struct AIMIcon: View {
  enum Name: CaseIterable {
    ...
    case chevron, check, doubleCheck, circle, square, checkSquare, folder, play, copy, trash, warning, info, success, terminal, openApp, menuBar, fan
...
// Adapted from Ionicons (MIT): complete both checks instead of omitting the overlap.
struct AIMDoubleCheckShape: Shape {
